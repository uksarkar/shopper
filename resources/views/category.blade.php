          ...
          <ol class="list-reset flex text-gray-600">
            ...
            @foreach (explode('/', $category->slug) as $k => $slug)
                @if($k > 0)
                  ...
                  <li class="text-blue font-light hover:text-teal-500 transition-250"><a href="{{ $category->getNameSlugOfCategory($slug)['slug'] }}">{{ $category->getNameSlugOfCategory($slug)['name'] }}</a></li>
                @endif
            @endforeach
          </ol>
        </nav>
