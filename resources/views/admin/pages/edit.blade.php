            ...
            <div class="container-fluid">
                ...
                <!-- /.row-->
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header"><i class="fa fa-edit"></i>Edit Page</div>
                                <div class="card-body">
                                    <form id="create-product" action="{{ route("page.update",$page->slug) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method("PATCH")
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-prepend"><span class="input-group-text">Title</span></div>
                                                    <input class="form-control" id="title" type="text" name="title" placeholder="page title" required value="{{ old("title",$page->title) }}">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <textarea class="textarea" type="text" name="descriptions" placeholder="Descriptions" required>{{ old("descriptions",$page->descriptions ) }}</textarea>
                                                </div>
                                            </div>
                                        <hr>
                                        <div class="form-group form-actions">
                                            <button class="btn btn-primary float-right" id="submit-btn" type="submit">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
