                                    ...
                                    <form id="create-product" action="{{ route("products.store") }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-9">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <textarea class="short_textarea" id="shortDescriptions" type="text" name="short_description" placeholder="Short Descriptions" required>{{ old("short_description") }}</textarea>
                                                    </div>
                                                </div>
