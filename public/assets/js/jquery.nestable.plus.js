...
var updateOutput = function (e) {
  ...
  if (window.JSON) {
    sendData = window.JSON.stringify(list.nestable('serialize'));
  } else {
...
var addToMenu = function () {
  ...
  nestableList.append(
    ...
    '<span class="button-delete btn btn-default btn-xs pull-right text-danger" ' +
    'data-owner-id="' + newId + '"> ' +
    '<i class="fa fa-times-circle-o" aria-hidden="true"></i> ' +
    '</span>' +
    '<span class="button-edit btn btn-default btn-xs pull-right text-success" ' +
    'data-owner-id="' + newId + '">' +
  ...
  // update JSON
  updateOutput($('.dd.nestable').data('output', $('#json-output')));
  $("#addInputName").val(null);
  $("#addInputSlug").val(null);
